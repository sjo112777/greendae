...
@AllArgsConstructor
@NoArgsConstructor
public class PageProfessorResponseDTO {

    private List<ProfessorDTO> dtoList;
    ...
    @Builder
    public PageProfessorResponseDTO(PageRequestDTO pageRequestDTO, List<ProfessorDTO> dtoList, int total) {
