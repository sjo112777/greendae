...
public class QBasicArticle extends EntityPathBase<BasicArticle> {
    ...
    public final ListPath<kr.co.greendae.entity.community.comment.BasicComment, kr.co.greendae.entity.community.comment.QBasicComment> basisComment = this.<kr.co.greendae.entity.community.comment.BasicComment, kr.co.greendae.entity.community.comment.QBasicComment>createList("basisComment", kr.co.greendae.entity.community.comment.BasicComment.class, kr.co.greendae.entity.community.comment.QBasicComment.class, PathInits.DIRECT2);
